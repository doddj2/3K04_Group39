...
def AOO_selections():
    ...
    file = username_info
    #create class object 
    AOO_screen = InputScreen_GARBAGE.InputScreenClass("AOO",file)
...
def VOO_selections(): ##literally the same as AOO except with some varible names swapped
    file = username_info
    VOO_screen = InputScreen_GARBAGE.InputScreenClass("VOO",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
...
def AAI_selections():
    file = username_info
    AAI_screen = InputScreen_GARBAGE.InputScreenClass("AAI",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
    ...
    AAI_screen.addInputBox([0,5],[0.1],"A Sensitivity (ms) ",0.75) #swap for VVI
...
def VVI_selections():
    file = username_info
    VVI_screen = InputScreen_GARBAGE.InputScreenClass("VVI",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
    VVI_screen.addInputBox([30,50,90,175],[5,1,5],"LRL (ppm) ",60) 
    VVI_screen.addInputBox([50,175],[5],"URL (ppm) ",120)
    VVI_screen.addInputBox([0.1,5],[0.1],"V Pulse Amplitude (V) ",5,TRUE)
    VVI_screen.addInputBox([1,30],[1],"V Pulse Width (ms) ",1)
    VVI_screen.addInputBox([0,5],[0.1],"V Sensitivity (ms) ",2.5) #swap for VVI
    VVI_screen.addInputBox([150,500],[10],"V Refractory Period (ms) ",320) #swap for VVI
    VVI_screen.addInputBox([30,50,90,175],[5,1,5],"Hysteresis Rate Limit (ms) ","OFF",TRUE) #same as LRL
    VVI_screen.addInputBox([3,21,25],[3,5],"Rate Smoothing (%)","OFF",TRUE) #edgecase needs testing 
    VVI_screen.open()
    main_account_screen()
def AOOR_selections():
    ...
    file = username_info
    #create class object 
    AOOR_screen = InputScreen_GARBAGE.InputScreenClass("AOOR",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
    ...
    main_account_screen()
    #file.close()
def VOOR_selections(): ##literally the same as AOO except with some varible names swapped
    file = username_info
    VOOR_screen = InputScreen_GARBAGE.InputScreenClass("VOOR",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
...
def AAIR_selections():
    file = username_info
    AAIR_screen = InputScreen_GARBAGE.InputScreenClass("AAIR",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
...
def VVIR_selections():
    file = username_info
    VVIR_screen = InputScreen_GARBAGE.InputScreenClass("VVIR",file)
    #ranges for inputs, increments for those ranges, label, default value, whether or not "Off" is a valid input for 0 = FALSE
