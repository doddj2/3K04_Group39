###########################################################################
## Makefile generated for component 'a2_changes_nov25'. 
## 
## Makefile     : a2_changes_nov25.mk
## Generated on : Sat Nov 26 02:08:39 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/a2_changes_nov25.elf
...
PRODUCT_NAME              = a2_changes_nov25
MAKEFILE                  = a2_changes_nov25.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/XUYUE~1/OneDrive/Desktop/REMOTE~1/3K04_G~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = a2_changes_nov25_comp.rsp
CMD_FILE                  = a2_changes_nov25.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/a2_changes_nov25.elf
...
DEFINES_ = -DMW_SERIAL1_RXBUF_SIZE=68 -DMW_SERIAL1_TXBUF_SIZE=66 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=a2_changes_nov25 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/a2_changes_nov25_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/a2_changes_nov25_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/a2_changes_nov25_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/a2_changes_nov25_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/a2_changes_nov25_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/a2_changes_nov25_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DCM_SEND.o : $(START_DIR)/a2_changes_nov25_ert_rtw/DCM_SEND.c
	$(CC) $(CFLAGS) -o "$@" "$<"


a2_changes_nov25.o : $(START_DIR)/a2_changes_nov25_ert_rtw/a2_changes_nov25.c
	$(CC) $(CFLAGS) -o "$@" "$<"


a2_changes_nov25_data.o : $(START_DIR)/a2_changes_nov25_ert_rtw/a2_changes_nov25_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
