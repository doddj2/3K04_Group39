...
void DCM_SEND(void)
{
  ...
  /* SignalConversion generated from: '<S5>/ATR_SIGNAL' */
  a2_B.TmpLatchAtATR_SIGNALOutport1 = a2_B.ATR_SIGNAL;

  /* SignalConversion generated from: '<S5>/VENT_SIGNAL' */
  a2_B.TmpLatchAtVENT_SIGNALOutport1 = a2_B.VENT_SIGNAL;
  ...
  /* Pack: <S5>/Byte Pack1 */
  (void) memcpy(&a2_B.BytePack1_g[0], &a2_B.TmpLatchAtATR_SIGNALOutport1,
                8);

  /* S-Function (any2byte): '<S5>/Byte Pack2' */

  /* Pack: <S5>/Byte Pack2 */
  (void) memcpy(&a2_B.BytePack2_c[0], &a2_B.TmpLatchAtVENT_SIGNALOutport1,
                8);
  ...
  for (i = 0; i < 8; i++) {
    ...
    a2_B.TmpSignalConversionAtSerial[i + 72] = a2_B.BytePack1_g[i];
    a2_B.TmpSignalConversionAtSerial[i + 80] = a2_B.BytePack2_c[i];
  }
  ...
  while (status != 0) {
    memcpy((void *)&a2_B.TxDataLocChar[0], (void *)
           &a2_B.TmpSignalConversionAtSerial[0], (uint32_T)((size_t)88 * sizeof
            (uint8_T)));
