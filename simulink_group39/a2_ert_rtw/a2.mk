...
## 
## Makefile     : a2.mk
## Generated on : Mon Nov 28 23:02:34 2022
...
START_DIR                 = C:/Users/yuexu/OneDrive/Desktop/final_version/3K04_Group39-1/simulink_group39
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = a2_comp.rsp
CMD_FILE                  = a2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/a2.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=74 -DMW_SERIAL0_TXBUF_SIZE=88 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=a2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o mw_sdk_interface.o MW_digitalIO.o MW_AnalogInput.o MW_SCI.o i2c_api.o MW_I2C.o DCM_SEND.o a2.o a2_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/a2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/a2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/a2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/a2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/a2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DCM_SEND.o : $(START_DIR)/a2_ert_rtw/DCM_SEND.c
	$(CC) $(CFLAGS) -o "$@" "$<"


a2.o : $(START_DIR)/a2_ert_rtw/a2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


a2_data.o : $(START_DIR)/a2_ert_rtw/a2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
