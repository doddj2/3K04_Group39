...
static void a2_VVIR(const real_T *Divide2_p, const boolean_T *VENT_CMP_DETECTD1,
                    const real_T *Gain1);
static void a2_enter_atomic_Charging(const real_T *Gain);
static void a2_AAIR(const real_T *Divide2_p, const boolean_T *ATR_CMP_DETECTD0,
                    const real_T *Gain);
  ...
  switch (a2_DW.is_VVIR) {
   case a2_IN_Alert_Period:
    if (*VENT_CMP_DETECTD1) {
      ...
      tmp = rt_roundd_snf((0.5 * *Divide2_p - a2_B.vent_pulse_width_h) - (real_T)
                          a2_B.VRP_j);
      if (tmp < 65536.0) {
        if (tmp >= 0.0) {
          tmp_0 = (uint16_T)tmp;
  ...
  switch (a2_DW.is_AAIR) {
   ...
   case a2_IN_Alert_Period_h:
    if (*ATR_CMP_DETECTD0) {
      ...
      tmp = rt_roundd_snf((0.5 * *Divide2_p - a2_B.atr_pulse_width_f) - (real_T)
                          a2_B.ARP_c);
      if (tmp < 65536.0) {
        if (tmp >= 0.0) {
          tmp_0 = (uint16_T)tmp;
...
void a2_step(void)
{
  ...
  MW_AnalogInSingle_ReadResult(a2_DW.obj_d.MW_ANALOGIN_HANDLE, &a2_B.ATR_SIGNAL,
    7);
  ...
  MW_AnalogInSingle_ReadResult(a2_DW.obj_o.MW_ANALOGIN_HANDLE, &a2_B.VENT_SIGNAL,
    7);
   ...
   */
  Gain = a2_B.atr_amp_p / a2_P.Constant_Value_i * a2_P.Gain_Gain_d;

  /* Gain: '<S8>/Gain1' incorporates:
   *  Constant: '<S8>/Constant1'
   *  Product: '<S8>/duty cycle calculation1'
   */
  Gain1 = a2_B.vent_amp_e / a2_P.Constant1_Value_c * a2_P.Gain1_Gain;
   ...
   *  Constant: '<S10>/1min = 60sec = 60000msec2'
   */
  Divide2 = a2_P.umin60sec60000msec2_Value / (real_T)a2_B.lower_rate_limit_p;
  ...
  if (a2_B.mode_f >= a2_P.Switch_Threshold) {
    a2_B.Divide2_p = a2_P.Constant_Value_n;
  } else {
    a2_B.Divide2_p = a2_P.Constant1_Value;
  }

  /* End of Switch: '<S15>/Switch' */

  /* Outputs for Enabled SubSystem: '<S11>/calculate acceleration(3D)' incorporates:
   *  EnablePort: '<S14>/Enable'
   */
  if (a2_B.Divide2_p > 0.0) {
  ...
  /* End of Outputs for SubSystem: '<S11>/calculate acceleration(3D)' */
  ...
  if (rtb_RelationalOperator) {
    a2_DW.Memory_PreviousInput += (real_T)(a2_B.MSR_g - a2_B.lower_rate_limit_p)
      / (real_T)a2_B.reaction_time_i;
    if (a2_DW.Memory_PreviousInput > a2_B.MSR_g) {
      a2_DW.Memory_PreviousInput = a2_B.MSR_g;
    }
  } else {
    a2_DW.Memory_PreviousInput += -(real_T)(a2_B.MSR_g - a2_B.lower_rate_limit_p)
      / (real_T)a2_B.recovery_time_e;
    if (a2_DW.Memory_PreviousInput < a2_B.lower_rate_limit_p) {
      a2_DW.Memory_PreviousInput = a2_B.lower_rate_limit_p;
    }
  }
   ...
   */
  a2_B.Divide2_p = a2_P.umin60sec60000msec2_Value_o / a2_DW.Memory_PreviousInput;
  ...
  if (a2_DW.is_active_c4_a2 == 0U) {
    ...
    switch (a2_DW.is_c4_a2) {
      ...
      switch (a2_DW.is_AAI) {
       ...
       case a2_IN_Alert_Period_h:
        if (tmp) {
          ...
          a2_B.Divide2_p = rt_roundd_snf(Divide2 - (real_T)a2_B.ARP_c);
          if (a2_B.Divide2_p < 65536.0) {
            if (a2_B.Divide2_p >= 0.0) {
              tmp_0 = (uint16_T)a2_B.Divide2_p;
            } else {
              tmp_0 = 0U;
            }
          } else {
     ...
     case a2_IN_AAIR:
      a2_AAIR(&a2_B.Divide2_p, &tmp, &Gain);
      break;
     ...
     case a2_IN_AOO:
      if (a2_DW.is_AOO == a2_IN_Charging) {
        ...
        a2_B.ATR_GND_CTRL = a2_HIGH;
        a2_B.VENT_GND_CTRL = a2_LOW;
        if (a2_DW.temporalCounter_i1 >= (uint32_T)ceil(Divide2 -
     ...
     case a2_IN_AOOR:
      if (a2_DW.is_AOOR == a2_IN_Charging) {
        ...
        a2_B.ATR_GND_CTRL = a2_HIGH;
        a2_B.VENT_GND_CTRL = a2_LOW;
        if (a2_DW.temporalCounter_i1 >= (uint32_T)ceil(0.5 * a2_B.Divide2_p -
             a2_B.atr_pulse_width_f)) {
     ...
     case a2_IN_VOOR:
      if (a2_DW.is_VOOR == a2_IN_Charging) {
        ...
        if (a2_B.mode_f != 4) {
          ...
          a2_DW.is_c4_a2 = a2_IN_Start;
        } else if (a2_DW.temporalCounter_i1 >= (uint32_T)ceil(0.5 *
                    a2_B.Divide2_p - a2_B.vent_pulse_width_h)) {
     ...
     case a2_IN_VVI:
      a2_VVI(&Divide2, &VENT_CMP_DETECTD1, &Gain1);
      break;

     default:
      /* case IN_VVIR: */
      a2_VVIR(&a2_B.Divide2_p, &VENT_CMP_DETECTD1, &Gain1);
      break;
    }
  }
  ...
  /* MATLABSystem: '<S1>/FRONTEND_CTRL D13' incorporates:
   *  Constant: '<S1>/Constant'
   */
  MW_digitalIO_write(a2_DW.obj_oh.MW_DIGITALIO_HANDLE, a2_P.Constant_Value_b !=
                     0.0);
...
{
  {
    freedomk64f_AnalogInput_a2_T *obj;
    freedomk64f_DigitalRead_a2_T *obj_1;
    freedomk64f_DigitalWrite_a2_T *obj_2;
    freedomk64f_PWMOutput_a2_T *obj_0;
    ...
    /* SystemInitialize for Enabled SubSystem: '<S11>/calculate acceleration(3D)' */
    ...
    /* End of SystemInitialize for SubSystem: '<S11>/calculate acceleration(3D)' */
    ...
    /* Start for MATLABSystem: '<S11>/Digital Write' */
    ...
    /* Start for MATLABSystem: '<S11>/Digital Write1' */
...
void a2_terminate(void)
{
  ...
  /* Terminate for Enabled SubSystem: '<S11>/calculate acceleration(3D)' */
  ...
  /* End of Terminate for SubSystem: '<S11>/calculate acceleration(3D)' */
  ...
  /* Terminate for MATLABSystem: '<S11>/Digital Write' */
  ...
  /* End of Terminate for MATLABSystem: '<S11>/Digital Write' */

  /* Terminate for MATLABSystem: '<S11>/Digital Write1' */
  ...
  /* End of Terminate for MATLABSystem: '<S11>/Digital Write1' */
}
