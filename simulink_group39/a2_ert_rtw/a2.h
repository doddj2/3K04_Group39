...
typedef struct {
  ...
  uint8_T TmpSignalConversionAtSerial[88];
  uint8_T RxData[74];
  ...
  uint8_T BytePack40[8];               /* '<S5>/Byte Pack40' */
  uint8_T BytePack41[2];               /* '<S5>/Byte Pack41' */
  uint8_T BytePack42[8];               /* '<S5>/Byte Pack42' */
  uint8_T BytePack1_g[8];              /* '<S5>/Byte Pack1' */
  uint8_T BytePack2_c[8];              /* '<S5>/Byte Pack2' */
  ...
  uint8_T MSR;
  uint8_T BytePack26;                  /* '<S5>/Byte Pack26' */
  uint8_T BytePack1;                   /* '<S5>/Byte Pack 1' */
  uint8_T BytePack2;                   /* '<S5>/Byte Pack 2' */
  uint8_T BytePack27;                  /* '<S5>/Byte Pack27' */
  uint8_T BytePack28[2];               /* '<S5>/Byte Pack28' */
  uint8_T BytePack29;                  /* '<S5>/Byte Pack29' */
  uint8_T BytePack30[8];               /* '<S5>/Byte Pack30' */
  uint8_T BytePack31[2];               /* '<S5>/Byte Pack31' */
  uint8_T BytePack32;                  /* '<S5>/Byte Pack32' */
  uint8_T BytePack34[8];               /* '<S5>/Byte Pack34' */
  uint8_T BytePack35[8];               /* '<S5>/Byte Pack35' */
...
typedef struct {
  ...
  freedomk64f_DigitalWrite_a2_T obj_g; /* '<S11>/Digital Write1' */
  freedomk64f_DigitalWrite_a2_T obj_e; /* '<S11>/Digital Write' */
  ...
  freedomk64f_SCIWrite_a2_T obj_j1;    /* '<S5>/Serial Transmit' */
...
struct P_a2_T_ {
  ...
  real_T umin60sec60000msec2_Value;    /* Expression: 60000
                                        * Referenced by: '<S10>/1min = 60sec = 60000msec2'
                                        */
  real_T umin60sec60000msec2_Value_o;  /* Expression: 60000
 ...
 *
 * Block '<S11>/acceleration' : Unused code path elimination
 ...
 * '<S4>'   : 'a2/Serial Com//Inputs/From DCM'
 * '<S5>'   : 'a2/Serial Com//Inputs/Function Call'
 * '<S6>'   : 'a2/VOO//AOO//VVI//AAI (R)/4 Modes'
 * '<S7>'   : 'a2/VOO//AOO//VVI//AAI (R)/Detection PWM'
 * '<S8>'   : 'a2/VOO//AOO//VVI//AAI (R)/Duty cycle calculation'
 * '<S9>'   : 'a2/VOO//AOO//VVI//AAI (R)/MATLAB Function'
 * '<S10>'  : 'a2/VOO//AOO//VVI//AAI (R)/Not ~~'
 * '<S11>'  : 'a2/VOO//AOO//VVI//AAI (R)/Subsystem'
 * '<S12>'  : 'a2/VOO//AOO//VVI//AAI (R)/Subsystem1'
