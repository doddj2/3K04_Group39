...
typedef struct {
  ...
  real_T ATR_AMP_a;                    /* '<S1>/From DCM' */
  real_T ATR_THRESH_o;                 /* '<S1>/From DCM' */
  real_T ATR_SENSE_n;                  /* '<S1>/From DCM' */
  real_T VENT_AMP_n;                   /* '<S1>/From DCM' */
  real_T VENT_THRESH_k;                /* '<S1>/From DCM' */
  real_T VENT_SENSE_d;                 /* '<S1>/From DCM' */
  ...
  uint16_T VENT_PW;
  uint16_T VRP;
  uint16_T LOWER_RATE_LIMIT_l;         /* '<S1>/From DCM' */
  uint16_T UPPER_RATE_LIMIT_j;         /* '<S1>/From DCM' */
  uint16_T PVARP_a;                    /* '<S1>/From DCM' */
  uint16_T MODE_i;                     /* '<S1>/From DCM' */
  uint16_T AV_DELAY_c;                 /* '<S1>/From DCM' */
  uint16_T REACT_TIME_n;               /* '<S1>/From DCM' */
  uint16_T RESP_FACTOR_k;              /* '<S1>/From DCM' */
  uint16_T RCVR_TIME_n;                /* '<S1>/From DCM' */
  uint16_T MAX_SENSE_l;                /* '<S1>/From DCM' */
  uint16_T ATR_PW_a;                   /* '<S1>/From DCM' */
  uint16_T ARP_i;                      /* '<S1>/From DCM' */
  uint16_T VENT_PW_g;                  /* '<S1>/From DCM' */
  uint16_T VRP_b;                      /* '<S1>/From DCM' */
...
typedef struct {
  ...
  uint16_T temporalCounter_i1_d;       /* '<S3>/Chart1' */
