...
void DCM_SEND(void)
{
  ...
  A2_V4_B.LOWER_RATE_LIMIT = A2_V4_B.LOWER_RATE_LIMIT_l;
  ...
  A2_V4_B.PVARP = A2_V4_B.PVARP_a;

  /* SignalConversion generated from: '<S5>/In4' */
  A2_V4_B.MODE = A2_V4_B.MODE_i;

  /* SignalConversion generated from: '<S5>/In5' */
  A2_V4_B.AV_DELAY = A2_V4_B.AV_DELAY_c;

  /* SignalConversion generated from: '<S5>/In6' */
  A2_V4_B.REACT_TIME = A2_V4_B.REACT_TIME_n;

  /* SignalConversion generated from: '<S5>/In7' */
  A2_V4_B.RESP_FACTOR = A2_V4_B.RESP_FACTOR_k;
  ...
  while (status != 0) {
    memcpy((void *)&A2_V4_B.TxDataLocChar[0], (void *)
           &A2_V4_B.TmpSignalConversionAtSerial[0], (uint32_T)((size_t)98 *
            sizeof(uint8_T)));
    status = MW_SCI_Transmit(A2_V4_DW.obj_l0.MW_SCIHANDLE,
      &A2_V4_B.TxDataLocChar[0], 98U);
  }
...
void DCM_SEND_Term(void)
{
  ...
  if (!A2_V4_DW.obj_l0.matlabCodegenIsDeleted) {
    A2_V4_DW.obj_l0.matlabCodegenIsDeleted = true;
    if ((A2_V4_DW.obj_l0.isInitialized == 1) && A2_V4_DW.obj_l0.isSetupComplete)
    {
      MW_SCI_Close(A2_V4_DW.obj_l0.MW_SCIHANDLE);
    }
  }
