###########################################################################
## Makefile generated for component 'A2_V4'. 
## 
## Makefile     : A2_V4.mk
## Generated on : Fri Nov 25 20:11:34 2022
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=84 -DMW_SERIAL0_TXBUF_SIZE=98 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
OBJS = MW_AnalogInput.o mw_sdk_interface.o MW_digitalIO.o MW_SCI.o MW_PWM.o i2c_api.o MW_I2C.o A2_V4.o A2_V4_data.o DCM_SEND.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
